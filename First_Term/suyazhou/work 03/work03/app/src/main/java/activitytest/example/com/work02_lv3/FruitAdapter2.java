...
public class FruitAdapter2 extends RecyclerView.Adapter<FruitAdapter2.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent , int viewtype) {
        ...
        final FruitAdapter2.ViewHolder holder2 = new FruitAdapter2.ViewHolder(view);
        holder2.fruitview.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        holder2.fruitImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                int position = holder2.getAdapterPosition();
                Fruit fruit = mFruitList.get(position);
