 ...
 * @简述:  安卓详情页面，展示webview
 */
public class AndroidDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textView = (TextView)findViewById(R.id.android_detail_text);
        textView.setText("资源地址："+data.getUrl());
        textView.setTextSize(17);

        textView2 = findViewById(R.id.android_detail_text2);
    ...
    private void addWebView(){
        LinearLayout linearLayout = findViewById(R.id.android_detail_ll);
