...
public class FirstFragment extends Fragment {
    ...
    public void update(final View view, String y){
        Log.d("y是是是是","http://www.wanandroid.com/article/list/"+y+"/json");
        HttpUtil.sendOkHttpRequest("http://www.wanandroid.com/article/list/"+y+"/json",new okhttp3.Callback(){
            @Override
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try{
                    ...
                    a = jsonObject1.getString("curPage");
                ...
                getActivity().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {//下拉刷新数据，并到达指定位置
                        swipeRefresh.setRefreshing(false);
                        recyclerView = (RecyclerView)view.findViewById(R.id.article_recycler);
                        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getActivity());
                        recyclerView.setLayoutManager(linearLayoutManager);
                        articleAdapter = new ArticleAdapter(articleTitle);
                        recyclerView.setAdapter(articleAdapter);
                        Log.d("这是",articleTitle.get(0).getTitle());
    ...
    public void initData(final View view,String X){
        ...
        HttpUtil.sendOkHttpRequest("http://www.wanandroid.com/article/list/"+X+"/json",new okhttp3.Callback(){
            @Override
            public void onFailure(Call call, IOException e) {
                e.printStackTrace();
                Intent intent =new Intent(getActivity(), NoInternetAtivity.class);
