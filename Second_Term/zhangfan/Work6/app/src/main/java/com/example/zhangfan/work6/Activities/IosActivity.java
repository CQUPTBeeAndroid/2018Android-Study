...
private List<JsonHttp.Results> androidItems = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText(tit);
        swipeRefreshLayout = findViewById(R.id.ios_swipe_refresh);
        swipeRefreshLayout.setColorSchemeColors(R.color.colorPrimary);
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                okHttpSendRequest("http://gank.io/api/data/iOS/20/1");
            }
        });
        RecyclerView recyclerView = (RecyclerView)findViewById(R.id.scend_ios_recyclerview);
        ...
        adapter.setOnItemClickListener(new OnItemClickListener1() {
            ...
            public void onItemClick(View view, int position, String str) {
                Toast.makeText(IosActivity.this, "click" + str, Toast.LENGTH_SHORT).show();
//                WebActivity.actionStart(AllActivity.this, androidItems.get(position));
                Intent intent1 = new Intent(IosActivity.this,WebActivity.class);
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE && lastVisibleItem + 1 ==
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Toast.makeText(IosActivity.this, "更新了10条数据...",
    ...
    private void inits(int position){
        String url = "http://gank.io/api/data/iOS/10/"+(position/10 +1);
        okHttpSendRequest(url);
    }
    private void urlHttpConnent(){
        HttpUtil.sendHttpRequest("http://gank.io/api/data/iOS/20/1", new HttpCallbackListener() {
            @Override
