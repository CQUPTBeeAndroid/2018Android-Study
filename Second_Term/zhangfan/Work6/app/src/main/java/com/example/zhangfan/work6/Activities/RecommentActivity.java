...
public class RecommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText(tit);
        swipeRefreshLayout = findViewById(R.id.recomment_swipe_refresh);
        swipeRefreshLayout.setColorSchemeColors(R.color.colorPrimary);
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                okHttpSendRequest("http://gank.io/api/data/瞎推荐/20/1");
            }
        });
        RecyclerView recyclerView = (RecyclerView)findViewById(R.id.scend_recomment_recyclerview);
        ...
        adapter.setOnItemClickListener(new OnItemClickListener1() {
            ...
            public void onItemClick(View view, int position, String str) {
                Toast.makeText(RecommentActivity.this, "click" + str, Toast.LENGTH_SHORT).show();
//                WebActivity.actionStart(AllActivity.this, androidItems.get(position));
                Intent intent1 = new Intent(RecommentActivity.this,WebActivity.class);
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE && lastVisibleItem + 1 ==
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Toast.makeText(RecommentActivity.this, "更新了10条数据...",
    ...
    private void inits(int position){
        String url = "http://gank.io/api/data/瞎推荐/10/"+(position/10 +1);
