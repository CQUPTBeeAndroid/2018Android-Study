...
public class ResourceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText(tit);
        swipeRefreshLayout = findViewById(R.id.resourse_swipe_refresh);
        swipeRefreshLayout.setColorSchemeColors(R.color.colorPrimary);
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                okHttpSendRequest("http://gank.io/api/data/拓展资源/20/1");
            }
        });

        RecyclerView recyclerView = (RecyclerView)findViewById(R.id.scend_resourse_recyclerview);
        ...
        adapter.setOnItemClickListener(new OnItemClickListener1() {
            ...
            public void onItemClick(View view, int position, String str) {
                Toast.makeText(ResourceActivity.this, "click" + str, Toast.LENGTH_SHORT).show();
//                WebActivity.actionStart(AllActivity.this, androidItems.get(position));
                Intent intent1 = new Intent(ResourceActivity.this,WebActivity.class);
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE && lastVisibleItem + 1 ==
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Toast.makeText(ResourceActivity.this, "更新了10条数据...",
    ...
    private void inits(int position){
        String url = "http://gank.io/api/data/拓展资源/10/"+(position/10 +1);
